...
lock "~> 3.17.2"
set :application, "hata"
set :repo_url, "git@github.com:amcolab/hata.git"
...
set :ssh_options,     { forward_agent: true, user: fetch(:user), keys: %w(~/.ssh/id_rsa.pub), auth_methods: %w(publickey), verify_host_key: :never }
